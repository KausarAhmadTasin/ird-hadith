...
const Sidebar = () => {
  return (
    <div className="lg:absolute hidden lg:left-0 h-full top-0 justify-center gap-y-6 pt-16 text-3xl text-[#747575] w-28  lg:flex flex-col items-center">
      ...
      <HiOutlineSquares2X2 className="hover:fill-[#2B9E76] hover:text-[#2B9E76]" />
      <GrSend className="hover:fill-[#2B9E76] hover:text-[#2B9E76]" />
      <div className="bg-[#2B9E76] lg:w-16 mt-9 w-10 m-1 lg:h-16 flex items-center justify-center h-10 text-white p-4 rounded-lg text-base lg:text-3xl">
        <BiSolidDonateHeart />
      </div>
    </div>
  );
